...
var MongoStorageAdapter = exports.MongoStorageAdapter = function () {
  ...
  _createClass(MongoStorageAdapter, [{
    ...
    key: 'leftJoin',
    value: function leftJoin(className, localField, from, foreignField, schema, leftQuery, query, _ref5) {
      var skip = _ref5.skip,
          limit = _ref5.limit,
          sort = _ref5.sort,
          keys = _ref5.keys,
      ...
      var mongoWhere = (0, _MongoTransform.transformWhere)(from, query, schema);
      var mongoSort = _lodash2.default.mapKeys(sort, function (value, fieldName) {
        return (0, _MongoTransform.transformKey)(className, fieldName, schema);
      });
      var mongoKeys = _lodash2.default.reduce(keys, function (memo, key) {
      ...
      return this._adaptiveCollection(className).then(function (collection) {
        ...
        return objects.reduce(function (memo, object) {
          return memo.concat(object[as].map(function (object) {
            return (0, _MongoTransform.mongoObjectToParseObject)(from, object, schema);
          }));
        }, []);
      });
    }
