  ...
  _createClass(MongoStorageAdapter, [{
    ...
    value: function deleteObjectsByQuery(className, schema, query) {
      ...
      return this._adaptiveCollection(className).then(function (collection) {
        ...
        if (result.n === 0) {
          throw new _node2.default.Error(_node2.default.Error.OBJECT_NOT_FOUND, 'Object not found.' + className);
        }
    ...
    value: function find(className, schema, query, _ref4) {
      ...
      debug('find', {
        ...
        query: query,
        mongoWhere: mongoWhere,
        options: { skip: skip, limit: limit, sort: sort, keys: keys, readPreference: readPreference }
      });
