...
var incrementOp = function incrementOp() {
  ...
  var key = arguments[1];
  var amount = arguments.length <= 2 || arguments[2] === undefined ? 1 : arguments[2];
...
function pushStatusHandler(config) {
  var objectId = arguments.length <= 1 || arguments[1] === undefined ? (0, _cryptoUtils.newObjectId)() : arguments[1];
